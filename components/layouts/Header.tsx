...
export function Header() {
  ...
  const { currentStore, currentUser, activeStoreUser, allStores, allStoreUsers, setCurrentStore, setActiveStoreUser } = useStore();
            ...
            >
              <div className="flex flex-col items-end">
                <span className="text-sm font-semibold text-neutral-900">
                  {activeStoreUser?.user_id?.full_name || currentUser?.full_name || 'Loading...'}
                </span>
                  ...
                  {allStoreUsers.map((user: any) => (
                    ...
                    >
                      <div className={`h-8 w-8 rounded-full flex items-center justify-center text-sm font-bold ${
                        ...
                        {user.user_id?.full_name?.charAt(0) || currentUser?.full_name?.charAt(0)}
                      </div>
                      <div>
                        <p className="text-sm font-medium">{user.user_id?.full_name || 'Unknown'}</p>
